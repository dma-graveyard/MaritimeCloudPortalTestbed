...
/**
 * GENERATED CLASS!
 * @see net.maritimecloud.serviceregistry.command.ServiceRegistryContract#organizationAliasRegistrationDenied
 */
@Event
public class OrganizationAliasRegistrationDenied {

    @TargetAggregateIdentifier
    private final OrganizationId organizationId;
    private final String alias;

    public OrganizationAliasRegistrationDenied(
