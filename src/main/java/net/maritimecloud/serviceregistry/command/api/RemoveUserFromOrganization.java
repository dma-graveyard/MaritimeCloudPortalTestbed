...
/**
 * GENERATED CLASS!
 * @see net.maritimecloud.serviceregistry.command.ServiceRegistryContract#removeUserFromOrganization
 */
public class RemoveUserFromOrganization implements Command {
