...
/**
 * GENERATED CLASS!
 * @see net.maritimecloud.serviceregistry.command.ServiceRegistryContract#userAcceptedMembershipToOrganization
 */
@Event
public class UserAcceptedMembershipToOrganization {
    ...
    public UserAcceptedMembershipToOrganization(
