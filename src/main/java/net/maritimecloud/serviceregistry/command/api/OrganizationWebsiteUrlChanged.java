...
/**
 * GENERATED CLASS!
 * @see net.maritimecloud.serviceregistry.command.ServiceRegistryContract#organizationWebsiteUrlChanged
 */
@Event
public class OrganizationWebsiteUrlChanged {

    @TargetAggregateIdentifier
    private final OrganizationId organizationId;
    private final String url;

    public OrganizationWebsiteUrlChanged(
