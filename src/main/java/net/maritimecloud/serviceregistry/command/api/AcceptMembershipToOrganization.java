...
/**
 * GENERATED CLASS!
 * @see net.maritimecloud.serviceregistry.command.ServiceRegistryContract#acceptMembershipToOrganization
 */
public class AcceptMembershipToOrganization implements Command {

    @TargetAggregateIdentifier
    private final MembershipId membershipId;

    @JsonCreator
    public AcceptMembershipToOrganization(
