...
/**
 * GENERATED CLASS!
 * @see net.maritimecloud.serviceregistry.command.ServiceRegistryContract#serviceInstanceAliasRemoved
 */
@Event
public class ServiceInstanceAliasRemoved {

    @TargetAggregateIdentifier
    private final OrganizationId organizationId;
    private final String alias;

    public ServiceInstanceAliasRemoved(
