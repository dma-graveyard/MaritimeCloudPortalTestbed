 ...
 */
public class SpringContextBasedRegistry {
    ...
    private static ApplicationContext getApplicationContext() {
        if (SpringContextBasedRegistry.applicationContext == null) {
    ...
    public synchronized void setApplicationContext(ApplicationContext anApplicationContext) throws BeansException {
        System.out.println("setApplicationContext called with: " + anApplicationContext);
        SpringContextBasedRegistry.applicationContext = anApplicationContext;
    }
